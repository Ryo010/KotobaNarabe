...
class Hiragana:
    ...
    json_array_url = os.path.join(BASE_DIR, "data", "hiragana-array.json")
    json_english_url = os.path.join(BASE_DIR, "data", "hiragana-english.json")
    ...
    def get_random_character_jp(self, choices: list, total_questions: int) -> list:
        try:
            ...
            print(
                "hiragana-array.json not found. Please create the file with the necessary configuration.")
            exit(1)
    ...
    def get_random_character_romaji(self) -> list:
        try:
            ...
            print(
                "hiragana-english.json not found. Please create the file with the necessary configuration.")
            exit(1)
